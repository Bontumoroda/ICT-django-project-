# Generated by Django 4.1.1 on 2022-11-02 19:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Ict Equipmaint', 'Ict Equipmaint'), ('Networking', 'Networking')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'pending'), ('fixed', 'fixed'), ('not fixed', 'not fixed')], default='pending', max_length=20, null=True)),
                ('date_created', models.DateTimeField(auto_now=True, null=True)),
